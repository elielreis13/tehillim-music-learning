---
number: 78
slug: modos-na-musica-moderna
title: Modos na música moderna
description: Lição focada em Modos na música moderna, separada do antigo módulo “Modos Eclesiásticos” para estudar um conceito por vez.
topics: Modos na música moderna
game_kind: game-listen
---

## Teoria

Modos na música moderna ajuda a entender a distância e a organização entre as notas. Esses padrões são a base da melodia, da harmonia, da transposição e da percepção auditiva.
...
Cartão visual central com o título “Modos na música moderna”, um exemplo musical simples e uma comparação lado a lado entre execução incorreta e execução correta.
...
- Estudar Modos na música moderna de forma isolada e aplicável ✓
