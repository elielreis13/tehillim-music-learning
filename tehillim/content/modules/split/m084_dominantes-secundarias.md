---
number: 84
slug: dominantes-secundarias
title: Dominantes secundárias
description: Lição focada em Dominantes secundárias, separada do antigo módulo “Progressões Harmônicas e Cadências” para estudar um conceito por vez.
topics: Dominantes secundárias
game_kind: game-challenge
---

## Teoria

Dominantes secundárias organiza os sons simultâneos e suas funções. A harmonia mostra de onde a música sai, para onde ela quer ir e onde encontra repouso.
...
Cartão visual central com o título “Dominantes secundárias”, um exemplo musical simples e uma comparação lado a lado entre execução incorreta e execução correta.
...
- Estudar Dominantes secundárias de forma isolada e aplicável ✓
...
MISSÃO DOMINANTES SECUNDÁRIAS: escolha uma música simples do repertório de louvor ou de estudo. Ouça uma vez procurando apenas Dominantes secundárias. Depois execute um trecho curto aplicando esse tema de propósito. Grave ou anote o resultado e responda: onde o conceito apareceu com clareza e onde ainda precisa de ajuste?
