...
slug: forma-musical
title: Forma musical
description: Lição focada em Forma musical, separada do antigo módulo “Forma Musical e Análise” para estudar um conceito por vez.
topics: Forma musical
game_kind: game-challenge
---

## Teoria

Esta lição isola o tema Forma musical dentro do estudo de Forma Musical e Análise. O foco é compreender um conceito por vez, reconhecer seus sinais e aplicar em situações musicais reais.
...
Cartão visual central com o título “Forma musical”, um exemplo musical simples e uma comparação lado a lado entre execução incorreta e execução correta.
...
- Estudar Forma musical de forma isolada e aplicável ✓
...
MISSÃO FORMA MUSICAL: escolha uma música simples do repertório de louvor ou de estudo. Ouça uma vez procurando apenas Forma musical. Depois execute um trecho curto aplicando esse tema de propósito. Grave ou anote o resultado e responda: onde o conceito apareceu com clareza e onde ainda precisa de ajuste?
